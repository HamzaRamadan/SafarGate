  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      toast({
        ...
        description:
          locale === "ar"
            ? "يتم الآن إزالة بياناتك من النظام."
              ...
              <SheetTrigger asChild>
                <div className="cursor-pointer">
                  <Image
                    ...
                    height={50}
                    priority
                    className="w-[110px] md:w-[180px] h-auto"
                  />
                </div>
              </SheetTrigger>
          ...
          <div className="flex items-center gap-2">
            {user ? (
              <div className="flex items-center gap-2 md:gap-3">
                {/* ✅ أيقونة الـ Notifications - مخفية في الموبايل */}
                <NotificationBell />

                <span className="text-sm font-medium hidden sm:inline-block">
                  {profile?.firstName ||
                    (locale === "ar" ? "المسافر" : "Traveler")}
                </span>
                ...
                {/* Language Switcher - ظاهر في الموبايل والديسكتوب */}
                <LanguageSwitcher />
              </div>
            ) : (
              <>
